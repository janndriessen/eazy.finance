// From https://github.com/compound-developers/compound-supply-examples
...
web3.eth
  ...
  .then(ganacheAccounts => {
    ...
    // 10000 tokens
    const numbTokensToMint = (10000 * Math.pow(10, ud)).toString();

    return underlyingContract.methods
      .transfer(accounts[0], numbTokensToMint)
      .send({
